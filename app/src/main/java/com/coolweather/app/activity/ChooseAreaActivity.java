...
public class ChooseAreaActivity extends Activity {
	...
	/**
	 * 查询选中市中所有的县，优先从数据库中查询，如果没有再去服务器查询
	 */
	...
	/**
	 * 捕获Back按键，根据当前的级别判断，此时返回市，省还是直接退出
	 */
	@Override
